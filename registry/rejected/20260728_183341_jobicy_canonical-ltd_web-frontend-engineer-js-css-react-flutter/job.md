...
Posted: 2026-07-21T16:19:31Z

## Rejection

- Category: stale
- Reason: published_at 2026-07-21T16:19:31Z is older than 7 days
...
In order to create consistency across our products and sites, we have a central team that builds an open-source [React toolkit](https://github.com/canonical/react-components) and presentation layer, the [Vanilla Framework](https://vanillaframework.io/). We are excited to develop this further and see if we can help more open-source projects build performant and accessible interfaces that respond well to diverse layouts. We use REST APIs for communication, and we consider API design an important part of the process.
...
For the entry level position in this advert, our compensation for US based candidates, lies between 48,000 USD to 70,000 USD. Our Early stage interview process will establish your level. If you are considered for a different level position than what is posted here, we will provide a wage scale or salary range specific to that level position.
