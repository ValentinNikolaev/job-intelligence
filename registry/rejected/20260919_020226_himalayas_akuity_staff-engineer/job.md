...
The team founded [Akuity](https://himalayas.app/companies/akuity) in 2021 to enable enterprises to ship software faster and more reliably with modern GitOps best practices. The [Akuity](https://himalayas.app/companies/akuity) Platform enables teams to manage the development and deployment across hundreds – if not thousands – of Kubernetes clusters from a single control plane. Trusted by top companies around the globe, the [Akuity](https://himalayas.app/companies/akuity) Platform provides the only end-to-end GitOps platform for the enterprises.
...
As a Staff Engineer at [Akuity](https://himalayas.app/companies/akuity), you will play a key technical leadership role in building and continuously improving [Akuity](https://himalayas.app/companies/akuity)’s SaaS platform for our global developer community. You’ll work closely with engineers, designers, and product partners to solve complex developer and infrastructure challenges, while driving technical direction and architectural decisions. You’ll also mentor engineers, promote engineering best practices, and help shape the technical culture of the company. This is an exciting opportunity to have a broad impact on developer tools and the developer ecosystem globally.

### What You’ll Own

- Design, build, test, and improve [Akuity](https://himalayas.app/companies/akuity)’s SaaS platform. You bring your expertise and commitment to excellence to build the best developer tools for our users, partners, and customers.
...
- Provide technical leadership and architectural guidance across complex, high-impact projects and initiatives.

- Mentor engineers and help drive engineering best practices across the organization.
...
- 4+ years of experience developing scalable web applications using Golang.
...
- Demonstrated experience leading the architecture and technical direction of complex, distributed systems.

- Experienced with relational databases (Postgres/MySQL).

- A genuine interest in designing a great end-to-end developer experience while using [Akuity](https://himalayas.app/companies/akuity)’s products.

- Exceptional communication skills and a collaborative mindset with a passion for developer experience.

- Proven ability to influence technical decisions across teams and work effectively in a highly collaborative environment.
