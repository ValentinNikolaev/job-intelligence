...
Posted: 2026-06-25T19:40:59Z

## Rejection

- Category: stale
- Reason: published_at 2026-06-25T19:40:59Z is older than 7 days

### About [Entando](https://himalayas.app/companies/entando)

At [Entando](https://himalayas.app/companies/entando) we're building the **next generation of our Composable Application Platform**.
Our vision is to enable enterprises to move **from ops to apps** in no time, assembling solutions at **lightspeed** through a **catalog-centric, cloud-native, and composable-first approach**.
...
This is not a feature-factory role. As part of the **core product team**, you will work on the **state-of-the-art foundations** of [Entando](https://himalayas.app/companies/entando)’s platform — including **isomorphic frameworks, event-driven architectures, state machines, Web Standards**, and more.
Your contributions will directly shape how enterprises build and scale composable apps in the coming decade.
