# Associate Director Business Management - Media Investment (Mensch)
...
Als **Associate Director Business Management - Media Investment (Mensch)** verantwortest du die Kundensteuerung in Investment Themen.

- **Kundenbudget-Monitoring:** Du übernimmst die Verantwortung für das Monitoring der Kundenbudgets.

- **Strategische Zusammenarbeit:** Eine enge Zusammenarbeit mit der Planung und Beratung bei strategischen und taktischen Fragestellungen zeichnet deine Arbeit aus.

- **Forecast Management:** Das Forecast Tracking und die Validierung gehören ebenfalls in deinen Verantwortungsbereich.

- **Rentabilitäts-Tracking:** Die Verantwortung für das Tracking der Kundenrentabilität liegt bei dir.

- **Vertragsmanagement:** Das Management von Verträgen (Media KPIs) in Zusammenarbeit mit Kundenteams und Fachabteilungen liegt in deiner Hand.

- **Team-Entwicklung:** Dein Aufgabenbereich umfasst auch die Aus- und Weiterbildung der Planungsteams in Business- und Investmentthemen.

## Das zeichnet dich aus

- **Berufserfahrung:** Du bringst eine mehrjährige Berufserfahrung in der Mediaplanung, -beratung oder im Investment Management mit, sei es von Agentur-, Beratungs- oder Kundenseite.

- **Analytische Fähigkeiten:** Dein ausgeprägtes analytisches Verständnis und die Begeisterung für Zahlen und Daten zeichnen dich aus.

- **Präsentationsstärke:** Komplexe Zusammenhänge kannst du zielgruppengerecht aufbereiten und überzeugend präsentieren.

- **Durchsetzungsvermögen:** Deine Durchsetzungsstärke und dein geschicktes Verhandlungsgeschick hast du bereits erfolgreich unter Beweis gestellt.

- **Arbeitsweise:** Teamorientiertes Arbeiten, eine schnelle Auffassungsgabe, Kontaktstärke, Organisationstalent und Flexibilität sind für dich selbstverständlich.

- **Sprach- und Softwarekenntnisse:** Sehr gute Kenntnisse in Deutsch, Englisch, Excel und PowerPoint runden dein Profil ab.

Darüber hinaus bist du: **#innovativ #teamorientiert**
