# Backend Developer - Product development - Java / Kotlin

Posted: 2026-08-14T20:31:11Z
...
Siamo alla ricerca di un compagno di squadra che possa prendere parte al team di prodotto GlueSync, partecipando attivamente allo sviluppo delle nuove funzionalità che ci vengono richieste dal mercato e alla co-creazione di nuove funzionalità di prodotto per essere sempre davanti ai competitors.

Il tuo compito sarà quello di partecipare attivamente nella scelta di tecnologie, pattern e metodi con cui realizzare le funzionalità di prodotto, con l’obiettivo di crescita per te e per i tuoi colleghi.
...
- Ktor (o frameworks analoghi)

- Rest API

- DI (Koin)

- JUnit (o testing frameworks analoghi)

- NoSQL (eg. MongoDB, Couchbase, DynamoDB, ...)

- SQL (SQL Server, Oracle DB, Postgres, ...)
...
- Esperienza con build tools (Gradle, Maven)

- Esperienza con static code analysis tooling configuration (ktlint, ...)
...
Corsi di formazione e certificazione per AWS, MongoDB / Realm, Couchbase e altri dei nostri partner in cui per-progetto occorrerà cimentarsi;
...
Possibilità di essere attivamente partecipe alle attività di advocay del nostro prodotto (se ti interessa), in qualità di speaker, blogger, vblogger, developer advocate o semplicemente aiutare il team durante i roadshow internazionali a divulgare il prodotto!

### RAL a partire da 40K €.
...
**MOLO17 **è focalizzata sulle tecnologie **NoSQL **per creare **p****rodotti** e **soluzioni** in grado di sbloccare il potenziale dei dati garantendo **nessun downtime** e **nessun impatto** alla business continuity. MOLO17 ha uffici in USA in Cupertino, CA e in EMEA con un R&D center a Pordenone, Italia.
...
Qui puoi approfondire riguardo al nostro recente award 😊
...
- Team di supporto e manutenzione applicativa: "Atlantis"
...
- Team di prodotto: sempre attento alle esigenze del mercato disegna e realizza prodotti usati da SI e database vendors in tutto il mondo
