...
- Zusätzlich im Senior Level: Du leitest komplexe KI-Projekte von der Ideenfindung bis zur Umsetzung.

- Du berätst Fachabteilungen und entwickelst maßgeschneiderte KI-Strategien.

- Zusätzlich im Senior Level: Du berätst Führungskräfte strategisch bei der Integration von KI-Lösungen.

- Du erstellst Konzepte, Machbarkeitsstudien und Prototypen.

- Zusätzlich im Senior Level: Du entwickelst und validierst Konzepte sowie performante KI-Architekturen.
...
- Zusätzlich im Senior Level: Du organisierst und moderierst interdisziplinäre Workshops und Schulungen.

- Du begleitest die Transformationen unserer Kund:innen im Bereich KI.

- Zusätzlich im Senior Level: Du analysierst Markttrends und identifizierst neue Geschäftspotenziale.
...
- Du bringst für die Rolle als Consultant 1-2 Jahre Berufserfahrung mit.

- Zusätzlich im Senior Level: Du bringst für die Rolle als Senior Consultant 2-5 Jahre Berufserfahrung mit.
...
- Du bist mit gängigen AI- und ML-Frameworks (z. B. PyTorch, TensorFlow, Langchain) sowie mit Datenbanksystemen (Vektor-/ Graphdatenbanken) vertraut und verfügst über ein sehr gutes Verständnis für die technische Umsetzung.
- Du bist sicher in der technischen Konzeption von Lösungsansätzen.
- Du verfügst über sehr starke analytische Fähigkeiten und Problemlösungskompetenz.
- Du brennst für Künstliche Intelligenz und hast einen visionären Blick darauf, wie AI die Geschäftswelt transformieren kann.
