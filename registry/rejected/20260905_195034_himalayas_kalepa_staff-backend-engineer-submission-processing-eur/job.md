# Staff Backend Engineer - Submission Processing (Europe)

Posted: 2026-07-14T07:37:00Z

## Rejection

- Category: stale
- Reason: published_at 2026-07-14T07:37:00Z is older than 7 days
...
We are looking for engineers who enjoy going deep on hard problems and owning end-to-end outcomes. As a Staff engineer on the Submission Processing team, you’ll work at the intersection of AI and backend engineering and have major ownership and agency: design the systems, make architectural calls under ambiguity, and play a key role in setting the technical direction for the team.

You’ll be working on building and scaling LLM-based systems that process billions of highly unstructured data points on a daily basis, extract precise information, and surface insights that insurers rely on for high-stakes decisions. This is a problem the industry hasn't solved effectively yet, and you'll be working on cutting-edge challenges that require creativity and ambition. We're a small team where individual contributions have an outsized impact on both our technology and our business.
...
- Have worked with LLMs in production and understand what it takes to deploy them at scale.

- Have experience with AWS and serverless technologies (Lambda, EC2), asynchronous workflows, and cloud environments.
...
- Are excited by problems others are struggling with.

- Bonus: experience with document pipelines and processing large amounts of data
