...
**We are looking for a Middle/Senior Go developer from anywhere in the world.**

**MadAppGang is a custom development company headquartered in Kremenchuk****, Ukraine and office in Sydney, Australia.**
...
All our projects are international (Europe, Middle East, Asia and Australia). Therefore, our second language of communication is English.

**About the project**

**Currently, we are looking for a Middle/Senior Go developer for our client, the Australian company Evergen.**
...
The goal is to get rid of coal-fired power plants in 10 countries, accelerating the world’s transition to renewable energy. Evergen’s partners — Tesla, LG, SolarEdge, etc.

Green projects are always cool, right? Products like this make the world a little better, cleaner and greener :)

**Technology stack and tools**

Go, Kafka, MongoDB, Redis, Docker, Kubernetes

**Agile practices****: **stand-up meetings, planning, retro, engineering meetings, demo.

**It is important for us**

- Experience in commercial backend development on Go.
...
- It’s perfect if your time zone is from GMT+2 to GMT+11.

**MadAppGang offers**

- Service contract with an Australian company.
- Full-time with a fixed hourly rate.
- Salary in USD — depends on your experience and expectations.
...
- **Wellness:** We care about your health, so we compensate 70% of the cost of the subscription to the gym (or another type of sports activity).
- **Compensation**: We compensate 30% if you decide to buy your personal equipment for work.
- **Work and life balance:** We guarantee you 20 working days of paid holidays a year.
