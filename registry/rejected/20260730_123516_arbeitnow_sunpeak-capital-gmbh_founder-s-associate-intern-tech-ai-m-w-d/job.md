...
- **Eigenverantwortliche Übernahme technischer und strategischer Projekte:** Du analysierst unsere internen Abläufe, entscheidest selbst, wo manueller Aufwand, Zeitverlust und Fehleranfälligkeit den größten Hebel bieten, und verantwortest die AI-gestützte Optimierung und Automatisierung dieser Prozesse von der Konzeption bis zum Rollout

- **Technische Betreuung und Optimierung unserer Website,** von kleineren Anpassungen bis zu neuen Features

- **Weiterentwicklung und Ausbau unserer Customer Journey Engine in HubSpot,** einschließlich Workflows und Prozessoptimierungen
...
- Du studierst Informatik, Data Science, Ingenieurwissenschaften, BWL/VWL oder einen vergleichbaren Studiengang an einer Top-Tier Universität

- Nachweisbare Erfahrung mit Automatisierungs- und AI-Tools (z. B. n8n, Zapier/Make, LLM-APIs, Prompt Engineering) und Lust, damit bestehende Prozesse in Sales, Reporting oder Analyse effizienter zu gestalten

- Nachweisbare Skills im Coding oder Scripting (z. B. Python), um eigenständig kleine Tools und Automatisierungen zu entwickeln, sind ein klarer Vorteil
...
- **Optimale technische Infrastruktur:** Du erhältst Zugang zu allen AI- und Automatisierungstools die du benötigst, ohne Einschränkungen in deiner täglichen Arbeit
