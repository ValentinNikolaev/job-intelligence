...
Posted: 2026-08-17T20:39:42Z

## Rejection

- Category: stale
- Reason: published_at 2026-08-17T20:39:42Z is older than 7 days
...
[Hostaway](https://himalayas.app/companies/hostaway) is seeking a highly motivated **Senior Backend Engineer** to join the Core team. This team is responsible for the integrations with our key partners (Online Travel Agencies). These integrations are critical to our customers’ daily workflows, powering seamless connectivity between their properties and major booking platforms. If you’ve worked on similar tools that handle huge volumes and interact with a variety of complex APIs, you’ll be a great fit!

### **What you'll do**

-

Design, build, and operate backend services in **PHP and Go.**
...
Collaborate closely with the **Product Manager **to shape the technical direction and ensure our backend services deliver maximum value.
...
Strong-level proficiency in **PHP** and/or **Golang**, with a strong willingness to dive into both.
...
**Performance** (page speed, latency, uptime) becomes a measurable strength of the products.
