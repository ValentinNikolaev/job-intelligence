# Senior Consultant – Media Audit & Value (Mensch)
...
Als **Senior Consultant – Media Audit & Value (Mensch)** verantwortest du das Management kundenindividueller Media Performance KPIs mit dem Ziel der Garantie Einhaltung.

- **Mediaplan-Analyse:** Detaillierte Analyse von Mediaplanungen zur Identifikation von Optimierungspotenzialen.

- **Empfehlungsableitung:** Ableitung konkreter Handlungsempfehlungen.

- **Zielerreichungs-Überwachung:** Überwachung der Zielerreichung und deren Einfluss auf kundenindividuelle Bonus-/Malus-Regelungen.

- **Vertragsanalyse:** Analyse und Interpretation von Kundenverträgen hinsichtlich Media Performance KPIs.

- **Tracking-Entwicklung:** Entwicklung und Implementierung von Tracking-Vorlagen basierend auf etablierten Audit-Methodiken.

- **Schnittstellenkommunikation:** Proaktive Schnittstellenkommunikation mit internen und externen Stakeholdern (lokal wie global).

## Das zeichnet dich aus:

- **Berufserfahrung: **Mindestens 4 Jahre Berufserfahrung in einer Media-Agentur, bei einem Auditor oder in einem vergleichbaren Umfeld.

- **Analytische Fähigkeiten: **Sehr starke analytische Fähigkeiten und sicherer Umgang mit großen und komplexen Datenmengen.

- **Softwarekenntnisse: **Sehr gute Excel-Kenntnisse.

- **Denkweise: **Unternehmerisches Denken und Bewertung von Chancen und Risiken.

- **Kommunikation: **Ausgeprägte Kommunikationsstärke über Hierarchie-Level hinweg.

- **Sprachkenntnisse: **Sehr gute Deutsch- und Englischkenntnisse in Wort und Schrift.

Darüber hinaus bist du:** #strukturiert #teamorientiert #eigenverantwortung**
