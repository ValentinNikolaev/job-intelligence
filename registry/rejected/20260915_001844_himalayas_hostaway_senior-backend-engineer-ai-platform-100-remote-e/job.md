...
Posted: 2026-09-06T04:20:17Z

## Rejection

- Category: stale
- Reason: published_at 2026-09-06T04:20:17Z is older than 7 days
...
As a Senior Backend Engineer on our AI Team, you’ll focus on integrating AI services into [Hostaway](https://himalayas.app/companies/hostaway)’s product. You’ll turn raw data and models into polished, customer-facing features by working in Python, building APIs, services, and UIs together with the Frontend engineers that make AI useful for property managers and guests.
...
Contribute to evolving our AI integration stack (Python SDKs, MCP servers, LLM orchestration).
...
Familiarity with LLM/AI tools (LangChain, Vercel AI SDK, MCP servers).
...
Nice to have: experience with PHP + Golang
...
AI-powered features are seamlessly embedded into [Hostaway](https://himalayas.app/companies/hostaway)’s SaaS product.
...
You become a go-to engineer for AI product integration across [Hostaway](https://himalayas.app/companies/hostaway).
