# Senior Backend Engineer - Databases - Loki Query | Sweden | Remote

Posted: 2026-07-23T12:05:13-04:00
...
The Databases team owns the telemetry databases that are[ Mimir for metrics](https://github.com/grafana/mimir),[ Loki for logs](https://github.com/grafana/loki),[ Tempo for traces](https://github.com/grafana/tempo), and[ Pyroscope for profiles](https://github.com/grafana/pyroscope). Our databases are OSS projects that we also offer as a Cloud service supporting Grafana Cloud, and as an on-premise solution. They are multi-tenant distributed systems implemented in Go and running on Kubernetes across all major Cloud service providers (GCP, Azure, AWS). We also have engineers working on[ Prometheus](https://github.com/prometheus/prometheus),[ Grafana Agent](https://github.com/grafana/agent),[ Mimir proxies](https://grafana.com/blog/2022/07/25/new-in-grafana-mimir-ingest-graphite-datadog-influx-and-prometheus-metrics-into-a-single-storage-backend/), and OpenTelemetry.
...
You'll also have access to the latest frontier models from OpenAI, Anthropic, and Google.
...
- Exposure to microservices architecture and distributed systems, and a desire to learn

- Familiarity with being on-call and performing operations/SRE tasks or with the concept of infrastructure as code

**Compensation & Rewards:**

In Sweden, the Base compensation range for this role is SEK 775,000 - SEK 969,000. Actual compensation may vary based on level, experience, and skillset as assessed in the interview process. Benefits include equity, bonus (if applicable) and other benefits listed [here](https://grafana.com/about/careers/#jobs).
