...
Our main tech hub is in London, but our engineers live everywhere in the UK— from Brighton to the Western Isles. We value meeting in person but we don't have a mandated requirement on office attendance, even if you're nearby. We believe you'll do your best work if you are where you want to be. If you live outside of London and we ask you to come into the office, Monzo will support you with the costs ✨
...
We're on the look out for L40 Engineers at the moment, you can read more in our [Engineering Progression Framework](https://monzo.com/documents/engineering-progression-framework-v4-1.pdf) you will be interviewed across the whole framework, so if you're not sure what level you're aiming for chat to your recruiter!
...
- [**Go**](http://golang.org/) to write our application code (there’s an excellent interactive Go tutorial [**here**](https://tour.golang.org/welcome/1))

- [**Cassandra**](http://cassandra.apache.org/) for most persistent data storage

- [**Kafka**](http://kafka.apache.org/) for our asynchronous message queue

- [**Kubernetes**](http://kubernetes.io/) and [**Docker**](https://www.docker.com/) to schedule and run our services

- [**Envoy Proxy**](https://www.envoyproxy.io/) for RPC

- [**AWS**](http://aws.amazon.com/) for most of our production infrastructure and[ **GCP**](https://cloud.google.com/) for most of our data infrastructure
...
One of our engineers has written a detailed blog on their experience through this process, for extra details, hints and tips please see [**here**](https://monzo.com/blog/2022/03/23/demystifying-the-backend-engineering-interview-process).

**What’s in it for you:**

£85,000 - £110,000 base salary +** **Incentive Awards tied to your performance
