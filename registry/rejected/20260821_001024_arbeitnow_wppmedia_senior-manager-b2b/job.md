...
Als **Senior Manager B2B **(Mensch) verstehst du die spezifischen Herausforderungen des B2B Bereichs, entwickelst strategische Lösungen für unsere Kunden, die ihnen helfen ihre Ziele im komplexen B2B Markt zu erreichen. Die Aufgabenstellung erstreckt sich in Abhängigkeit von den Kunden- und Agenturanforderungen vom End-to-End-Kampagnenmanagement (Planung & Beratung) bis zur Unterstützung des Client Service sowie der New Business Teams.

- **Strategieentwicklung:** Du erarbeitest strategischer Empfehlungen auf Basis des Kunden-Briefings.

- **Kampagnenplanung:** Du bist verantwortlich für die Entwicklung und Planung der B2B Kampagnen in allen Kanälen, mit deutlichem Fokus auf Digital und Print.

- **Markt- und Media-Insights** Du recherchierst und identifizierst die geeigneten Medien und Kanäle für die optimale Zielgruppenansprache unter Berücksichtigung definierter KPIs.

- **Kampagnenumsetzung:** In enger Abstimmung mit weiteren Abteilungen begleitest du die Kampagne bis zum finalen Reporting.

- **Performance-Monitoring:** Anhand von KPIs analysierst du die Kampagnenleistung, identifizierst Optimierungspotenziale und leitest wirkungsvolle Handlungsempfehlungen ab.

- **Zusammenarbeit:** Du arbeitest sowohl eng mit internen Abteilungen als auch Vermarktern und Kunden zusammen.

## Das zeichnet dich aus:

- **Medienerfahrung:** Du hast Erfahrung in der Steuerung und Optimierung von B2B Kampagnen oder in der Digitalplanung.

- **Fachkenntnisse:** Du bist mit den gängigen Planungstools vertraut und kennst die relevanten Mediabegriffe und KPIs.

- **Strategisches Denken:** Du verfügst über sehr gute analytische Fähigkeiten sowie eine ausgeprägte strategische und lösungsorientierte Denkweise.

- **Kommunikationsstärke:** Komplexe Sachverhalte verständlich und überzeugend zu erklären, ist für dich selbstverständlich.
