...
- Category: stale
- Reason: published_at 2026-09-11 is older than 7 days

**This position is open only to candidates currently residing in Ukraine (preferably in Kyiv or Lviv).**

Our product team is looking for an experienced Golang developer. You’ll help create robust, mission‑critical systems. We’re primarily looking for mid-level specialists. However, if you’re more senior and have a background in cryptography, security, or systems programming, we’d be happy to talk.
...
- Strong knowledge of Go (3+ years): syntax, idioms, and common patterns.
- Solid understanding of engineering fundamentals including algorithms, concurrency, multithreading, data structures, design patterns, networks.
...
- Confident debugging skills: practical experience in diagnosing problems at any level (application, network, server, database, OS).
...
- Resume review — up to 7 business days.
...
- Conferences, books, courses — we encourage learning and sharing with the community. Our team members share a a lot in [**talks, workshops**](https://www.cossacklabs.com/conferences/), and [**blog posts**](https://www.cossacklabs.com/blog/)
- Public track record in the open-source aspect of our products.

At our company we engineer and deploy end‑to‑end solutions for the world’s most critical infrastructure—both defense systems and power grid operations. Working side‑by‑side with operators, vendors, and manufacturers from Ukrainian to global dual‑use firms, we guide projects from initial design through field deployment, ensuring that OT and IT environments are fully hardened against targeted cyber and physical attacks. In every engagement the stakes are tangible: a failure means blackouts or mission loss rather than just an SLA violation.
