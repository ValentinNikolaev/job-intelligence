...
- **IT-Support & Troubleshooting:** Mitarbeit im 1st- und 2nd-Level-Support, inklusive Fehleranalyse und Behebung von Störungen in Windows, Software und mobilen Geräten; Unterstützung der Anwender per Remote-Tools wie TeamViewer oder AnyDesk

- **Arbeitsplätze & Administration:** Einrichtung, Bereitstellung und Betreuung moderner Arbeitsplätze (Clients, Peripherie, Software) sowie Verwaltung von Benutzer- und Zugriffsrechten im lokalen Active Directory und Entra ID

- **Plattform- & Richtlinienmanagement:** Weiterentwicklung und Administration der Intune-Plattform (MDM/MAM) sowie Erstellung, Pflege und Optimierung von Richtlinien im Client- und Modern-Workplace-Umfeld

- **Dokumentation:** Pflege und Optimierung von Prozessen und Arbeitsabläufen zur Sicherstellung von Transparenz und Nachvollziehbarkeit

**DU BIETEST**

- **Ausbildung:** Erfolgreich abgeschlossene Ausbildung im Bereich Informatik oder eine vergleichbare Qualifikation

- **IT-Support-Erfahrung:** Kenntnisse im 1st- und 2nd-Level-Support für Clients, Anwendungen und Peripherie

- **ITSM-Systeme:** Erfahrung im Umgang mit IT-Service-Management-Systemen, z. B. Freshservice, ServiceNow oder Jira Service Management

- **Administration:** Erfahrung in der Verwaltung von MS365-Umgebungen und Entra AD

- **Arbeitsweise:** Du besitzt eine hohe Eigenmotivation, Eigeninitiative sowie Kommunikations- und Teamfähigkeit und lösungsorientiertes, zuverlässiges Arbeiten ist für dich selbstverständlich
