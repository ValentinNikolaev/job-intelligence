# Software Developer, Billing Integrations

Posted: 2026-07-01T02:04:01Z

## Rejection

- Category: stale
- Reason: published_at 2026-07-01T02:04:01Z is older than 7 days
...
**We’re hiring a Developer for the following team:**

Billing & Payments Engineering Integrations: The Billing & Payments Engineering team builds and owns the mission-critical systems that power 1Password’s revenue engine end-to-end. We are responsible for the highly available architecture that enables seamless subscription management, complex payment processing, and global financial compliance. From managing the intricate logic of the subscription lifecycle—creations, renewals, upgrades, and cancellations—to integrating with diverse payment gateways and app-store ecosystems, our work ensures a frictionless experience for our customers. As a team, we are actively architecting the next generation of our billing infrastructure, modernizing and consolidating our systems to support rapidly scaling product lines, guarantee absolute data integrity, and ensure robust integrations with downstream financial workflows.
...
- You enjoy solving complex problems with a demonstrated ability propose effective solutions
...
- Billing & Payments: Experience building or maintaining billing, payment processing, or subscription platforms (e.g., Stripe, native app stores).

- Distributed Systems: A strong background in designing and scaling highly available, fault-tolerant distributed architectures.

- API Integrations: Proven ability to build resilient integrations with third-party APIs, including handling webhooks, retries, and strict idempotency.
...
The post [Software Developer, Billing Integrations](https://jobspresso.co/job/software-developer-billing-integrations/) appeared first on [Jobspresso](https://jobspresso.co).
