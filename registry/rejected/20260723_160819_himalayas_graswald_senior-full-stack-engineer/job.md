...
Posted: 2026-07-06T12:43:05Z

## Rejection

- Category: stale
- Reason: published_at 2026-07-06T12:43:05Z is older than 7 days
...
**About Us**
At [Graswald](https://himalayas.app/companies/graswald) AI, we’re building the AI operating system for fashion brands and retailers, starting with AI image and content generation. Our engineering team tackles rapid scaling challenges, GPU-intensive workloads, and enterprise-grade infrastructure to deliver fast, pixel-perfect results for global brands. In the past year alone, we’ve signed 50 enterprise fashion clients who rely on us to reduce costs and accelerate creative timelines. Backed by leading VCs and strategic investors including **Lakestar** and Orendt Studios, and preparing for a Series A later this year, we’re growing fast and building technology that is already reshaping how fashion content is produced

**The Role:**
The Senior Full Stack Software Engineer is a core member of a product team, responsible for designing, building, testing, and deploying high-quality software. Engineers work closely with their Team Lead (TL) and Product Manager (PM) to turn product requirements into reliable, scalable features that deliver real value to users.
Engineers at [Graswald](https://himalayas.app/companies/graswald) operate in a highly dynamic environment, where requirements and architectures evolve quickly. This role requires comfort with ambiguity, strong ownership, and the ability to make pragmatic technical decisions with incomplete information.
...
- An entrepreneurial spirit with the ability to adapt and grow quickly as the organization scales.
**Nice to have:**

- Experience with generative AI tooling (Stable Diffusion, ComfyUI) or creative platforms (p5.js, Three.js).
**Education:**

- A minimum of a Bachelor's degree in Computer Science, Information Technology, or a similar technical field.

### why us?

**Why Join Us:**
**Impact:** Help redefine AI-driven content creation for the world’s biggest brands.
**Innovation:** Work with cutting-edge AI models and push the boundaries of generative visuals.
**Fast-Paced Execution:** We move quickly, iterate rapidly, and work closely with customers to build what they need.
**Growth:** Join a high-caliber, fast-scaling startup with huge opportunities for career advancement.
**Culture:** Be part of a passionate, collaborative team that values creativity, problem-solving, and technical excellence.
