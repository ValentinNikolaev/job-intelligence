# Paid Social Performance Manager (Mensch)
...
Als **Paid Social Performance Manager (Mensch) **bist du verantwortlich für die technische Umsetzung von Online-Kampagnen unserer Kund:innen, speziell in dem Bereich der Kampagnenimplementierung.

- **Qualitätssicherung:** Du bist unser Qualitäts-Adler! Bevor eine Kampagne live geht oder Änderungen gemacht werden, checkst du alles doppelt und dreifach in den Ad-Plattformen – egal ob im Meta Business Manager, TikTok Business Manager oder anderswo.

- **Strategie: **Als Go-to-Expert:in für unsere Kund:innen, wenn es um die Frage geht: "Wie setzen wir das jetzt am besten um?", stehst du ihnen mit Rat und Tat zur Seite, berätst sie strategisch und hilfst ihnen, die richtigen Entscheidungen für das Kampagnen-Setup zu treffen.

- **Performance Optimierung:** Hier spielst du den Kampagnen-Detektiv! Du tauchst tief in die Zahlen ein, analysierst unsere KPIs ganz genau und gibst den Kampagnen den letzten Schliff.

- **Reporting & Datenaufbereitung: **Die Daten hast du im Blick und lieferst Ad-hoc Anfragen für interne Abteilungen.

## Das zeichnet dich aus:

- **Qualifikation:** Du bringst eine erfolgreich abgeschlossene technische oder kaufmännische Ausbildung oder Studium mit.

- **Office Anwendungen:** Den Spaß im Umgang mit Microsoft Office Produkten verlierst du nicht und scheust dich auch nicht, insbesondere in Excel zu arbeiten.

- **Lernbereitschaft:** Deine ständige Begeisterung für digitale Themen und Neugierde "wie funktioniert es genau?", gehört zu deinem Lebensmotto dazu.

- **Weiterentwicklung: **Egal welche Entwicklungswünsche du anstrebst, deine Art voran zu kommen, bleibt nie "on-Hold".

- **Teamplayer: **Du bist verlässlich und fungierst immer gerne als Sparringspartner.

- **Sprachkenntnisse: **Die Kommunikation beherrst du sowohl auf deutsch als auch auf englisch.

Darüber hinaus bist du:** #teamplayer #neugierig #proaktiv**
