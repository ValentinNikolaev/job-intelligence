...
- [investigating](https://nebius.com/blog/posts/training-and-search-for-software-engineering-agents) how test-time guided search can be used to build more powerful agents;

- dramatically [scaling](https://nebius.com/blog/posts/scaling-data-collection-for-training-swe-agents) task data collection to power reinforcement learning for SWE agents;

- [maximizing efficiency](https://nebius.com/blog/posts/kvax-open-source-flash-attention-for-jax) of LLM training on agentic trajectories.

One example of an AI product that we are deeply involved in is Nebius Token Factory — an [inference](https://nebius.com/studio/inference) and [fine-tuning](https://nebius.com/services/studio-fine-tuning) platform for AI models.
