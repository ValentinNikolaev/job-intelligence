...
- **Take-Home Technical Assessment:** A practical coding exercise focused on Kotlin and Jetpack Compose to evaluate structural code quality, layout precision, and architectural foundations.
- **Technical Deep-Dive Interview:** A rigorous evaluation with the Mobile Engineering Team Lead and the CTO/Co-Founder to discuss system architecture, implementation trade-offs, and product design philosophies.
- **Behavioral & Alignment Interview:** A final "Bar Raiser" discussion with a company Co-Founder to evaluate cross-functional collaboration, strategic product vision, and cultural integration.
