...
- **Serverlandschaft:** Verwaltung, Überwachung und Weiterentwicklung der Serverlandschaft.

- **Netzwerkinfrastruktur:** Betreuung und Sicherstellung einer stabilen Netzwerkinfrastruktur.

- **Störungsmanagement:** Analyse und Behebung von Störungen im Server- und Netzwerkbetrieb.

- **IT-Sicherheit & Performance:** Umsetzung von Maßnahmen zur IT-Sicherheit, Verfügbarkeit und Systemperformance.

- **Projekte & Zusammenarbeit:** Mitarbeit bei Infrastrukturprojekten sowie Zusammenarbeit mit internen Teams und externen Dienstleistern.

- **Ticketsystem & Dokumentation:** Bearbeitung, Dokumentation und Nachverfolgung von Tickets im ITSM-System sowie Dokumentation von Systemen, Änderungen und technischen Prozessen.

**DU BIETEST**

- **Ausbildung:** Abgeschlossene Ausbildung als Fachinformatiker für Systemintegration oder vergleichbare Qualifikation.

- **Berufserfahrung:** Mehrjährige Erfahrung in der Administration von Server- und Netzwerkinfrastrukturen wünschenswert.

- **Microsoft-Umgebungen:** Gute Kenntnisse in Microsoft-Serverumgebungen, Active Directory, Gruppenrichtlinien und Microsoft 365.

- **Virtualisierung & Monitoring:** Erfahrung mit Virtualisierungstechnologien, Backup-Systemen und Monitoring-Lösungen.

- **Netzwerktechnologien:** Fundierte Kenntnisse in TCP/IP, VLAN, DNS, DHCP, VPN und Firewalling; Grundverständnis für IT-Sicherheit und Datenschutz von Vorteil.
