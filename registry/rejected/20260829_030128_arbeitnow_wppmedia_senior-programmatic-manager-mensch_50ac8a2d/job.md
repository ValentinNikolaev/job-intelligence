...
Als **Senior Programmatic Manager** (Mensch) bist du sowohl für die strategische Entwicklung der Programmatic-Aktivitäten als auch die operative Umsetzung deren für unsere Kund:innen verantwortlich. Du agierst mit deinem Team als Sprachrohr, um programmatische Standards und Guidelines innerhalb der Agentur zu prägen.

- **Strategie:** Strategisch evaluierst du gemeinsam mit unseren Kund:innen, welche Innovationen und Technologien ihren programmatischen Einkauf am gewinnbringendsten gestalten.

- **Zahlenverständnis:** Mit deinem ausgeprägten Zahlenverständnis entwickelst du den programmatischen Mediaeinkauf kontinuierlich weiter, um gesetzte Ziele und Media-KPIs nicht nur zu erreichen, sondern auch zu übertreffen.

- **Kampagnenmanagement:** Die präzise Umsetzung der zuvor entwickelten Kampagnen-Strukturen und Cases in den verschiedenen DSPs und zugehörigen Technologien fällt in deinen Verantwortungsbereich.

- **Netzwerken:** Du pflegst eine enge und produktive Zusammenarbeit mit internen Spezialisten-Teams und externen Partnern in einem dynamischen, internationalen Umfeld.

- **Entwicklung:** Kund:innen berätst du strategisch zu den entscheidenden Vorteilen des programmatischen Einkaufs für ihre Gesamtstrategie.

## Das zeichnet dich aus:

- **Qualifikation:** Ein abgeschlossener Hochschulabschluss sowie mind. 3 Jahre nachweisliche Expertise in der operativen Steuerung oder strategischen Beratung programmatischer Kampagnen.

- **Data & Tech:** Du hast ein profundes Verständnis der digitalen Media-Landschaft, inklusive DSPs, Datenmanagement-Plattformen, Inventare und Verifikationstechnologien.

- **Neugierde & Lernbereitschaft:** Stehenzubleiben ist für dich keine Option! Daher bringst du auch die Ambition mit, dich immer weiterzuentwickeln, damit auch Teammitglieder, Kund:innen & co. von deinem Fachwissen profitieren können.

- **Datenaufbereitung:** Durch deinen präzisen und strukturierten Blick auf Daten in Excel und PowerPoint, kannst du komplexe Sachverhalte klar und strategisch sowie verständlich vermitteln.

- **Sprachkenntnisse:** Die Kommunikation auf Deutsch und Englisch beherrschst du in Wort und Schrift.

Darüber hinaus bist du:** #teamfähig #kommunikativ #lösungsorientiert**
