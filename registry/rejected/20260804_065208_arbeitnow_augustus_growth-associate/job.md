...
This is your entry role into GTM. You will join the commercial team at Augustus. You will learn the playbook for going to market and your mission will be to scale one of our core growth channels. You will either run and scale the outbound system, run fairs across the globe, build the sales enablement system, or build our referral partner engine. If you succeed in this role, this is your entry into a Sales role, or establishing yourself as a leader for your growth channel.

# **Your First Six Months**

-

**Months 1-2:** You talk to every team: Sales, AM, RevOps, Product. You understand our customers, products, revenue model, and where the gaps are. You set up your first campaigns, create lists, and work with the sales team on converting the pipeline.

-

**Months 3-4**: You will own one of our core growth channels, defining the roadmap, scaling our efforts, and taking them to the next level.

-

**Months 5-6:** Your growth channel has a significant impact on our top-line growth and produces new pipeline reliably. You work together with the GTM team to automate manual processes and set new boundaries of what's possible.
...
You're passionate about GTM or you want to learn the skillset to build your own company.

-

You're comfortable without a playbook; unknown territories excite you, not paralyze you.

-

You're structured and a systems thinker - you hate it when things break.

-

You bring energy to work, lead by example, and make the people around you better.

**This is not for you if:**

-

You struggle to make decisions without complete information.

-

You want a clearly defined role with pre-built systems to maintain, not build.

-

You are not savvy about GTM technology.

# **Hard Requirements**

-

First internships in a fast-paced environment.
...
Compensation packages at Augustus include base salary, equity, and benefits. New hire offers are made based on a candidate's experience, expertise and geographic location. The annual base salary range for this role is €60,000-€80,000 + equity.
...
Compensation: €60K – €80K • Offers Equity
