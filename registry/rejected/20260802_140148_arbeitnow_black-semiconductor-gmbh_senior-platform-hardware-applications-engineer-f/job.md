...
Programming and scripting experience for PC-based platforms to control demonstrations, automate experiments, interface with test equipment, and analyze data.

-

Hands-on experience using laboratory equipment including oscilloscopes, voltmeters, logic analyzers, pattern generators, and related high-speed debug tools.

-

Experience with FPGA programming and development tool flows.

-

Familiarity with PCB CAD tools for schematic capture and layout, Microsoft Office, and engineering documentation and drawing tools.
