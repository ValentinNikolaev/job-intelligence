# Senior Developer Advocate (Education), EMEA
...
** We are looking for a Senior Developer Advocate (Education focus) to:**

-

Teach a community of automation, no-code and open source builders, meeting them where they already are with practical how-tos, helping them get unstuck, and building relationships with our most active members

-

Owns certified courses and depth content, then turn it into short-form built for each channel: videos, livestreams, blogs, meetups and social

-

Work the whole funnel, so awareness content pulls new builders in and activation content gets signed-up users to real proficiency and keeps them there

-

Enable our partners to deliver, exploring co-marketing and curriculum opportunities alongside the partner team

-

Hold the accuracy bar, because a wrong instruction is expensive for our reputation

-

Monitor success metrics, consider how effective initiatives are at achieving goals and adjust effort accordingly (completion, certification pass rates, proficiency gains, etc)

-

Design for learning outcomes: set clear objectives, scaffold from first touch to proficiency, and build the practice and assessment that prove someone can do the thing

**Requirements**

-

5+ years working in tech, with 2+ years in Developer Relations or Developer Education

-

You've taught and built community across some of these channels: YouTube, short-form video, courses, blogs, meetups, public speaking and events

-

You identify first as a teacher, and also as a learner, a builder and a doer, a mentor and a communicator

-

You're empathetic, inclusive, warm, enthusiastic, and you get a buzz from helping people learn

-

You're passionate about automation, no-code and/or open source

-

Comfortable building real n8n workflows and spotting your own errors, since accuracy is the job

-

Bonus: experience with instructional design, assessment writing, or certification programs
