...
This is a remote opportunity and we would be interested in applicants from the United States Eastern time zones only at this time.
...
[Grafana k6](https://grafana.com/docs/k6/latest/) is an open-source project focused on making performance testing practical, approachable, and useful in real-world engineering workflows. We care deeply about developer experience, correctness, and scalability. k6 is part of the Grafana ecosystem and is used by engineers to test and understand systems under real load.
...
In this role, you will work on features and improvements across the [k6 codebase](https://github.com/grafana/k6), from initial idea through implementation and delivery. Much of the work involves problems that are not fully specified up front and require understanding the context, evaluating trade-offs, and choosing a reasonable technical approach.
...
In the United States, the Base compensation range for this role is USD 154,445 – USD 185,334. Actual compensation may vary based on level, experience, and skillset as assessed in the interview process. All of our roles include Restricted Stock Units (RSUs), giving every team member ownership in Grafana Labs’ success. We believe in shared outcomes—RSUs help us stay aligned and invested as we scale globally.
...
The post [Senior Software Engineer – k6 Core](https://jobspresso.co/job/senior-software-engineer-k6-core/) appeared first on [Jobspresso](https://jobspresso.co).
