...
Posted: 2026-07-02T19:29:26Z

## Rejection

- Category: stale
- Reason: published_at 2026-07-02T19:29:26Z is older than 7 days

### What is [Amplemarket](https://himalayas.app/companies/amplemarket) all about?

[Amplemarket](https://himalayas.app/companies/amplemarket)'s premise is that a lot of the playbooks used by B2B sales teams that worked 5 years ago don't cut it anymore.

In today's environment, sales teams need to have a tremendous amount of information about their prospects to decide when is the best moment and channel to reach out in the most relevant way. You can't do this with 5 different data/sales enablement point solutions that don't share the same data schema and barely communicate with each other. [Amplemarket](https://himalayas.app/companies/amplemarket) is the all-in-one compound solution that enables this.
...
It has come to our attention that there are fraudulent activities targeting job seekers, where individuals are impersonating [Amplemarket](https://himalayas.app/companies/amplemarket) by using fake profiles, domains, and emails.
...
If you have any doubts about the legitimacy of a job opportunity with [Amplemarket](https://himalayas.app/companies/amplemarket), please contact our HR department directly.

We advise you to verify the authenticity of any job-related communications claiming to be from [Amplemarket](https://himalayas.app/companies/amplemarket). If you have any concerns or doubts, please contact us directly through our official channels.

Your security is our priority. Thank you for your vigilance and understanding.

### Software engineers build the core of [Amplemarket](https://himalayas.app/companies/amplemarket).

Backend engineers build the core of [Amplemarket](https://himalayas.app/companies/amplemarket). The three co-founders have an engineering background (João, Luís and Mica studied Physics & Computer Science in university) and deeply value the work that engineers are responsible for.
...
Our customers use [Amplemarket](https://himalayas.app/companies/amplemarket) on a daily basis. We keep and enrich valuable data that is critical for sales reps's success. We need to keep these TB of data organized and easily accessible. Luckily, you are reading this, and when you join [Amplemarket](https://himalayas.app/companies/amplemarket) our performance will skyrocket.

As an early member of engineering team, you will build reliable backend systems and design state-of-the-art APIs to enable new product features. You will work cross functionally in a fullstack team and in close collaboration with product, design, customer success, support, and sales functions.
