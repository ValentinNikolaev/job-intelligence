...
Under the hood: attribution across complex user journeys, AI-based recommendation engines, multi-tenant infrastructure serving hundreds of customers, scaling millions of events. Deeper than you'd expect from a referral tool.
...
Work with the following stack: **React** · **Typescript** · **NestJS ** · **Python **· **AWS**
...
**Strong work ethic** - you take ownership, ship what you commit to, and don't need to be chased
...
In the end, it’s all about the team and our culture. Understand why we love our job and see what it’s like to work at Cello in our People Playbook. We have some compelling perks and benefits [here](https://cello-growth.notion.site/People-Playbook-59cf404a0de5444ab0732ec905925179?source=copy_link).
