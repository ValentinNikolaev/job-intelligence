# Senior Engineer - Proxmox (m/w/d) - Remote
...
*„In der Portfolio Unit Security & IT Solutions sorgen wir für die Sicherheit und Stabilität der IT-Systeme unserer Kunden. Gemeinsam übernehmen wir hier Verantwortung, liefern Produkte und professionellen Service, entwickeln und betreiben Lösungen und sorgen mit Freude dafür, dass die Welt ein Stück sicherer wird." - Christoph Wolf, Director PU Security & IT Solutions*

Du fühlst Dich angesprochen und möchtest gemeinsam mit uns die Welt sicherer machen? Unser Team wächst stetig und wir suchen Dich als Senior Engineer (m/w/d) für Proxmox-Plattform an einem unserer Standorte, um unsere Kunden gemeinsam bestmöglich zu beraten und zu unterstützen.

### **WAS DU BEI UNS MACHST**

- Aufbau, Weiterentwicklung und Betrieb unserer zukünftigen Virtualisierungsplattform auf Basis von Proxmox VE

- Planung und Durchführung von Migrationsprojekten im Rahmen der strategischen Ablösung bestehender VMware-Umgebungen

- Integration und Weiterentwicklung von Storage-, Netzwerk- und SDN-Komponenten zur Sicherstellung einer leistungsfähigen und hochverfügbaren Infrastruktur

- Erstellung von Betriebs-, Architektur- und Migrationskonzepten sowie Unterstützung bei Technologie- und Architekturentscheidungen

- Automatisierung und Optimierung von Betriebsprozessen sowie Sicherstellung eines stabilen Betriebs der Plattform

### **WIE DU UNS BEGEISTERST**

- Erfolgreich abgeschlossene Ausbildung im IT-Umfeld, ein Studium der Informatik oder eine vergleichbare Qualifikation

- Mehrjährige Erfahrung im Betrieb und der Weiterentwicklung von Virtualisierungsplattformen sowie praktische Erfahrung mit Proxmox VE

- Sehr gute Linux-Kenntnisse sowie fundiertes Know-how in den Bereichen Enterprise Storage, Netzwerkarchitekturen und SDN-Technologien

- Erfahrung in Infrastrukturtransformations- und Migrationsprojekten sowie ein ausgeprägtes Architekturverständnis

- Hohe Eigenverantwortung sowie Bereitschaft für Rufbereitschaften bzw. geplante 24/7 Wartungsarbeiten
...
Bei Fragen kannst Du Dich gerne per ▶ Anna Scherer (Talent Acquisition Partnerin) wenden.
