# Product Engineer (Data Indexing)

Posted: 2026-08-09T12:14:22Z

Are you a strong backend engineer who enjoys building high-performance systems and owning products end to end? Join [Chainstack](https://himalayas.app/companies/chainstack) and help power the next generation of blockchain data infrastructure.

### About us

[Chainstack](https://himalayas.app/companies/chainstack) powers global blockchain applications across fintech, DeFi, wallets, custodians, analytics, and everything in between. Teams cut time-to-market, cost, and risk with one platform for nodes in the cloud, offered through preferred service providers, or self-hosted. Standardized node management puts reliability on autopilot and keeps performance predictable, giving operators control and transparency while developers get a consistent way to build and scale.

### About the role

We are looking for a Product Engineer to join our data team and build systems for high-scale blockchain data access, indexing, and performance. In this role, you will own problems end to end, from understanding user needs to building, shipping, and improving production systems. You will work on performance-sensitive APIs, large datasets, and distributed systems, while applying AI-first development workflows.
...
- Experience with blockchain infrastructure, blockchain data, RPC APIs, archive data, indexing, or node operations.

- Experience with high-volume data pipelines, event streaming, workflow orchestration, analytical databases, or object storage.

- Experience with spec-first workflows such as RFCs, ADRs, or similar engineering planning practices.

- Experience building internal tools, diagnostic CLIs, benchmark suites, repair workflows, or operational automation.

- Familiarity with AI tools for research, documentation, data analysis, code generation, and verification.

- Experience working in infrastructure teams with direct ownership of reliability and performance outcomes.

### What we offer

- Competitive salary in USD - Fair, transparent compensation based on experience and impact.

- Stock options - Share in [Chainstack](https://himalayas.app/companies/chainstack)'s growth and long-term success.

- AI-first environment - Use AI to reduce repetitive work and focus on judgment and shipping.
