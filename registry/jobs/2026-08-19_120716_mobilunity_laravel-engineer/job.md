...
On behalf of our Client from **France**, Mobilunity is looking for a **Laravel Engineer**.
...
They are looking for a developer to join their Al squad and assist in implementing Al features using various tools and connecting them to the existing stack built on Laravel. The ideal candidate will play a crucial role in bridging the TypeScript part to PHP within the tech stack.

**Responsibilities:**

- Work closely with the Al squad to implement Al features
- Utilize multiple tools to enhance Al capabilities
- Connect Al features to our existing Laravel stack
- Bridge the TypeScript part to PHP within the tech stack

**Requirements:**

- 5+ years of professional software development experience, with PHP/Laravel as your primary backend stack
- TypeScript skills — you can read, write using ai, and review Node.js code confidently
...
- Active user of Al development tools (Claude Code, Cursor, Copilot, or similar) — you’ve integrated these into your daily workflow and are curious about pushing them further
- Upper-intermediate to advanced English proficiency

**Will Be a Plus:**

- Solid Experience of using generative Al in production
- Familiarity with OAuth2 / OIDC flows and APl authentication patterns (API keys, tokens, scopes)
