...
6. Prepare exactly this vacancy with `$job-intelligence-workflow` preparation rules.
   ...
   the recent-experience editorial gate from `$job-intelligence-workflow`: recent
   roles carry the majority of substantive Experience bullets and older roles remain
   compact;
